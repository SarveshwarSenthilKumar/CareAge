...
export default function RequestHelpFlowPage() {
  return (
    <div className="flex min-h-screen flex-col">
      <SiteHeader />
      <main className="flex-1 flex items-center justify-center bg-gradient-to-b from-background to-muted">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-8">Request Help</h1>
          <p className="mb-8 text-xl">To request help, please log in or sign up.</p>
          <div className="flex flex-col sm:flex-row gap-8 justify-center">
            <Link href="/login?flow=request-help" className="w-64 h-64">
              <Button
                size="lg"
            ...
            <Link href="/signup?flow=request-help" className="w-64 h-64">
              <Button
                size="lg"
                variant="outline"
                className="w-full h-full p-4 rounded-2xl flex flex-col items-center justify-center transition-transform hover:scale-105"
